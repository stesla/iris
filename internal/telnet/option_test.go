...
func TestOptionStateReceive(t *testing.T) {
	var tests = []struct {
		...
		{DO, optionState{allowUs: true, us: qNo}, optionState{allowUs: true, us: qYes}, &send{[]byte{IAC, WILL}}},
		{DO, optionState{us: qNo}, optionState{us: qNo}, &send{[]byte{IAC, WONT}}},
		...
		{DO, optionState{us: qWantYesOpposite}, optionState{us: qWantNoEmpty}, &send{[]byte{IAC, WONT}}},

		{DONT, optionState{us: qNo}, optionState{us: qNo}, nil},
		{DONT, optionState{us: qYes}, optionState{us: qNo}, &send{[]byte{IAC, WONT}}},
		{DONT, optionState{us: qWantNoEmpty}, optionState{us: qNo}, nil},
		{DONT, optionState{us: qWantNoOpposite}, optionState{us: qWantYesEmpty}, &send{[]byte{IAC, WILL}}},
		{DONT, optionState{us: qWantYesEmpty}, optionState{us: qNo}, nil},
		{DONT, optionState{us: qWantYesOpposite}, optionState{us: qNo}, nil},

		{WILL, optionState{allowThem: true, them: qNo}, optionState{allowThem: true, them: qYes}, &send{[]byte{IAC, DO}}},
		{WILL, optionState{them: qNo}, optionState{them: qNo}, &send{[]byte{IAC, DONT}}},
		...
		{WILL, optionState{them: qWantYesOpposite}, optionState{them: qWantNoEmpty}, &send{[]byte{IAC, DONT}}},

		{WONT, optionState{them: qNo}, optionState{them: qNo}, nil},
		{WONT, optionState{them: qYes}, optionState{them: qNo}, &send{[]byte{IAC, DONT}}},
		{WONT, optionState{them: qWantNoEmpty}, optionState{them: qNo}, nil},
		{WONT, optionState{them: qWantNoOpposite}, optionState{them: qWantYesEmpty}, &send{[]byte{IAC, DO}}},
	...
	for i, test := range tests {
		...
		if ev, ok := test.ev.(*send); ok {
			ev.data = append(ev.data, Echo)
			require.Equal(t, ev, eventReceived, i)
		} else {
...
func TestOptionEnable(t *testing.T) {
	...
	var tests = []struct {
		...
		{disableThem, optionState{them: qYes}, optionState{them: qWantNoEmpty}, &send{[]byte{IAC, DONT}}},
		...
		{disableUs, optionState{us: qYes}, optionState{us: qWantNoEmpty}, &send{[]byte{IAC, WONT}}},
		...
		{enableThem, optionState{them: qNo}, optionState{them: qWantYesEmpty}, &send{[]byte{IAC, DO}}},
		...
		{enableUs, optionState{us: qNo}, optionState{us: qWantYesEmpty}, &send{[]byte{IAC, WILL}}},
